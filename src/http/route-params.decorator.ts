 ...
 * @publicApi
 */
export function Cookie(property?: string | (Type<PipeTransform> | PipeTransform)): ParameterDecorator {
    return createRouteParamDecorator(RouteParamtypes.Cookie)(property);
}

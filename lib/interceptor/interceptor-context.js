...
class InterceptorContext extends context_creator_1.default {
    ...
    intercept(interceptors, args, instance, next, context) {
        ...
        const nextFn = (i = 0) => async () => {
            ...
            const args = this.paramsContext.getArgsByMap(argsMap, context, next);
...
exports.default = InterceptorContext;
